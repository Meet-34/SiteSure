!(function (t, e) {
  ...
  function Pt(e, i) {
    ...
    return function (...t) {
      return (
        i ? (clearTimeout(s), (s = setTimeout(e, i, t))) : e.apply(this, t),
        i
      );
    };
  }
  ...
  const Zt =
    ...
    Qt = (t) => (t <= 0.04045 ? t / 12.92 : Math.pow((t + 0.055) / 1.055, 2.4));
  function te(e, i, s) {
    if (e) {
      let t = Yt(e);
  ...
  function Li(t, i, g) {
    ...
    const { property: s, start: a, end: n } = g,
      ...
      { compare: r, between: l, normalize: h } = Ai(s),
      {
        ...
        return (
          d < c && (d += r),
          { start: c, end: d, loop: u, style: t.style }
        );
      })(t, i),
      p = [];
    let m,
    ...
    return Ii(
      ...
      !0 === n
        ...
        : (function (t, e, i, s) {
            ...
            return (
              null !== r && n.push({ start: e % a, end: r % a, loop: s }),
              n
            );
  ...
  class Os {
    ...
    _resolveElementOptions(t, e = "default", i) {
      ...
      return (
        g.$shared && ((g.$shared = r), (a[n] = Object.freeze(Cs(g, r)))),
        g
      );
    }
  ...
  function wa(t, e, i, s) {
    ...
    for (d = 0; d <= h; ++d)
      (u = a[(r + (p ? h - d : d)) % o]).skip ||
        ...
        (g = u));
    return (
      l && ((u = a[(r + (p ? h : 0)) % o]), c(t, g, u, p, n.stepped)),
      !!l
    );
  }
  function ka(t, e, i, s) {
  ...
  function sn(t, e, i) {
    let s,
      ...
      l = t.length - 1;
    i
      ? (e >= t[r].pos && e <= t[l].pos && ({ lo: r, hi: l } = f(t, "pos", e)),
        ({ pos: s, time: n } = t[r]),
        ({ pos: a, time: o } = t[l]))
      : (e >= t[r].time &&
          e <= t[l].time &&
