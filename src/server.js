...
app.get("/gallery", (req, res) =>
  res.sendFile(path.join(__dirname, "..", "client", "pages", "gallery.html")),
);
app.get("/success", (req, res) =>
  res.sendFile(path.join(__dirname, "..", "client", "pages", "success.html")),
);
app.get("/materiallog", (req, res) =>
  res.sendFile(path.join(__dirname, "..", "client", "pages", "materiallog.html")),
);
...
app.post("/api/reports/submit", upload.single("image"), async (req, res) => {
  const { date, location, workType, description, issues, actions, engineer } =
    req.body;
